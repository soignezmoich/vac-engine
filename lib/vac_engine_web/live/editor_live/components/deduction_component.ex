defmodule VacEngineWeb.EditorLive.DeductionComponent do
  ...
  alias VacEngineWeb.EditorLive.BranchComponent, as: Branch
  alias VacEngineWeb.EditorLive.DeductionHeaderComponent, as: DeductionHeader
  alias VacEngineWeb.EditorLive.CellComponent, as: Cell
