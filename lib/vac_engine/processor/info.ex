defmodule VacEngine.Processor.Info do
  ...
  Each part of the description is generated by the `Processor.Info.Logic.logic/1`,
  the `VacEngine.Processor.Info.Schema.input_schema/1` and the
  `VacEngine.Processor.Info.Schema.output_schema/1` functions.
  """
