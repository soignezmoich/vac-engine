%{
  ...
  deductions: [
    ...
    %{
      columns: [
        %{type: "assignment", variable: :birthday_16}
      ],
      branches: [
        %{
          assignments: [
            %{
              target: :birthday_16,
              expression: quote(do: add_years(@birthdate, 16)),
              column: 0
            }
          ]
        }
    ...
    branches: [
      ...
      %{
        conditions: [
          %{
            column: 6,
            expression: quote(do: lt(@end_of_registration_window, @birthday_16)),
          }
        ],
        assignments: [
          %{
      ...
      %{
        ...
        assignments: [
          ...
          %{
            ...
            expression: quote(do: latest(@end_of_infection_delay, @end_of_booster_delay, @birthday_16))
          }
        ],
      },
      %{
        assignments: [
          ...
          %{
            column: 8,
            target: :end_of_delays_moderna,
            expression: quote(do: latest(@end_of_infection_delay, @birthday_16))
          }
        ],
      },
    ]
