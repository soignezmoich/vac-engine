    ...
    [
      ...
      groups_for_modules: [
        ...
        Web: [
          ...
          VacEngineWeb.BlueprintLive.Edit,
          VacEngineWeb.BlueprintLive.ImportComponent,
          VacEngineWeb.BlueprintLive.Index,
          VacEngineWeb.BlueprintLive.New,
          VacEngineWeb.BlueprintLive.Pick,
          VacEngineWeb.BlueprintLive.SummaryComponent,
          VacEngineWeb.ButtonComponent,
          VacEngineWeb.ConnHelpers,
          VacEngineWeb.DashboardLive.Index,
          VacEngineWeb.EditorLive.BranchComponent,
          VacEngineWeb.EditorLive.CellComponent,
          VacEngineWeb.EditorLive.DeductionActionGroupComponent,
          VacEngineWeb.EditorLive.DeductionComponent,
          VacEngineWeb.EditorLive.DeductionEditorComponent,
          VacEngineWeb.EditorLive.DeductionHeaderComponent,
          VacEngineWeb.EditorLive.DeductionListComponent,
          VacEngineWeb.EditorLive.ExpressionEditorComponent,
          VacEngineWeb.EditorLive.VariableActionGroupComponent,
          VacEngineWeb.EditorLive.VariableComponent,
          VacEngineWeb.EditorLive.VariableEditorComponent,
          VacEngineWeb.EditorLive.VariableInspectorComponent,
          VacEngineWeb.EditorLive.VariableListComponent,
          VacEngineWeb.Endpoint,
          VacEngineWeb.ErrorHelpers,
          VacEngineWeb.ErrorView,
          VacEngineWeb.ExportController,
          ...
          VacEngineWeb.InlineSearchComponent,
          ...
          VacEngineWeb.PermissionToggleComponent,
          VacEngineWeb.PortalLive.Edit,
          VacEngineWeb.PortalLive.Index,
          VacEngineWeb.PortalLive.New,
          VacEngineWeb.Router,
